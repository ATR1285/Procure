...
This module uses the new AIClient that supports Gemini 1.5 Pro (primary),
GPT-4o (fallback), and rule-based fallback.

The analyze_invoice_with_ai function provides a robust interface for
vendor matching and data extraction using cloud LLMs.
"""
